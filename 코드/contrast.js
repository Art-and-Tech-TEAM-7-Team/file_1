export function makeContrastSketch(){
    return function(p){
        ...
        p.preload = function(){
            ...
            carIMG = p.loadImage("assets/car.png");
            subwayIMG = p.loadImage("assets/subway.png");
            car2IMG = p.loadImage("assets/car2.png");
            car3IMG = p.loadImage("assets/car3.png");
            noteImages[0]=p.loadImage("assets/note1.png");
            noteImages[1]=p.loadImage("assets/note2.png");
            thinkingIMG= p.loadImage("assets/thinking.png");
        } 
